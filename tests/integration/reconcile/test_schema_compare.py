...
def snowflake_databricks_schema():
    src_schema = [
        ...
        schema_fixture_factory("col_escaped", "double", normalized_ansi="`col_escaped`", normalized_source="col_escaped"), # production snowflake normalize is not implemented
...
def oracle_databricks_schema():
    src_schema = [
        ...
        schema_fixture_factory("col_escaped", "double", normalized_ansi="`col_escaped`", normalized_source="col_escaped"), # production oracle normalize is not implemented
        schema_fixture_factory("`col Escaped2`", "float", source_delimiter='"'),
        schema_fixture_factory('"col escaped3"', "float", source_delimiter='"'),
        schema_fixture_factory('"col""escaped4"', "float", source_delimiter='"'),
        schema_fixture_factory('"col`escaped5"', "float", source_delimiter='"'),
