...
_CONFIG_PATH = _REPO_ROOT / "src/databricks/labs/lakebridge/resources/assessments/redshift/pipeline_config.yml"


def test_redshift_queries_match_duckdb_ddl() -> None:
    ...
    for step in config["steps"]:
        ...
        query = sqlglot.parse_one(query_path.read_text(encoding="utf-8"), read="redshift")
