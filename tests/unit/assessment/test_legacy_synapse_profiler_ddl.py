...
_CONFIG_PATH = _REPO_ROOT / "src/databricks/labs/lakebridge/resources/assessments/legacy_synapse/pipeline_config.yml"


def test_legacy_synapse_queries_match_duckdb_ddl() -> None:
