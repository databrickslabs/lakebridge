...
PLATFORM_TO_SOURCE_TECHNOLOGY_CFG = {
    ...
    "synapse_dedicated_sqlpool": (
        "src/databricks/labs/lakebridge/resources/assessments/synapse_dedicated_sqlpool/pipeline_config.yml"
    ),
}

# TODO modify this PLATFORM_TO_SOURCE_TECHNOLOGY.keys() once all platforms are supported
PROFILER_SOURCE_SYSTEM = ["synapse", "mssql", "synapse_dedicated_sqlpool"]
...
CONNECTOR_REQUIRED = {"synapse": False, "mssql": True, "synapse_dedicated_sqlpool": True}
