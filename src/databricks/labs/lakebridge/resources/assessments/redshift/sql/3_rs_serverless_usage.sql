...
-- Combines compute (compute_seconds) with billing (charged_seconds, rpu_hours, legacy cost).
...
select trunc(start_time) as "day"
      ...
      ,(sum(charged_seconds) / 3600.0 * 0.36)::double precision as legacy_cost_incurred
