...
adaptations:
  * No filesystem I/O — `compile()` accepts raw SQL text and returns the substituted text.
...
class Compiler:
    ...
    @classmethod
    def from_json(cls, substitutions_json: str, **variables: Any) -> "Compiler":
        return cls(json.loads(substitutions_json), **variables)

    def compile(self, sql_filename: str, raw_sql: str) -> str:
        """
