CREATE TABLE IF NOT EXISTS metrics (
    ...
    recon_metrics STRUCT<
                        ...
                        row_comparison: STRUCT<
                                              ...
                                              > COMMENT 'Row presence diffs; null unless report_type in (all,row,data).',
                        column_comparison: STRUCT<
                                                 ...
                                                 > COMMENT 'Column-value diffs; null unless report_type in (all,data).',
                        schema_comparison: BOOLEAN COMMENT 'True if schema matched; null unless report_type in (all,schema).'
    ...
    CONSTRAINT metrics_pk PRIMARY KEY (recon_table_id),
    CONSTRAINT metrics_main_fk FOREIGN KEY (recon_table_id) REFERENCES main (recon_table_id)
)
