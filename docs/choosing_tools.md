...
## Assessment: Profiler vs Analyzer[​](#assessment-profiler-vs-analyzer "Direct link to Assessment: Profiler vs Analyzer")
...
## Transpiler: BladeBridge vs Morpheus vs Switch[​](#transpiler-bladebridge-vs-morpheus-vs-switch "Direct link to Transpiler: BladeBridge vs Morpheus vs Switch")
...
### When to choose Morpheus[​](#when-to-choose-morpheus "Direct link to When to choose Morpheus")
...
### When to choose BladeBridge[​](#when-to-choose-bladebridge "Direct link to When to choose BladeBridge")
...
### When to choose Switch[​](#when-to-choose-switch "Direct link to When to choose Switch")
...
## Still not sure?[​](#still-not-sure "Direct link to Still not sure?")
...
For everything else, check the [supported dialects table](/lakebridge/docs/transpile.md#supported-dialects) and pick the transpiler that covers your source.
