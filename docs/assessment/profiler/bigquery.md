...
### 2. Authenticate to GCP[​](#2-authenticate-to-gcp "Direct link to 2. Authenticate to GCP")
...
### 3. Required IAM permissions on the target BigQuery project(s)[​](#3-required-iam-permissions-on-the-target-bigquery-projects "Direct link to 3. Required IAM permissions on the target BigQuery project(s)")
...
### 4. INFORMATION\_SCHEMA / region-scoped views accessed[​](#4-information_schema--region-scoped-views-accessed "Direct link to 4. INFORMATION_SCHEMA / region-scoped views accessed")
...
## Configure Connection to BigQuery[​](#configure-connection-to-bigquery "Direct link to Configure Connection to BigQuery")
