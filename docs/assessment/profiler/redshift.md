...
### 2. Choose the Redshift deployment variant[​](#2-choose-the-redshift-deployment-variant "Direct link to 2. Choose the Redshift deployment variant")
...
| **provisioned\_multi\_az** | Multi-AZ provisioned cluster  |

### 3. Network connectivity[​](#3-network-connectivity "Direct link to 3. Network connectivity")
...
### 4. Authentication[​](#4-authentication "Direct link to 4. Authentication")
...
### 5. Database privileges[​](#5-database-privileges "Direct link to 5. Database privileges")
