...
## Running the Command[​](#running-the-command "Direct link to Running the Command")
...
## What Happens After You Run[​](#what-happens-after-you-run "Direct link to What Happens After You Run")
...
## Data Behavior Details[​](#data-behavior-details "Direct link to Data Behavior Details")
...
## Error Reference[​](#error-reference "Direct link to Error Reference")
...
* [Configure Profiler](/lakebridge/docs/assessment/profiler.md#configure-profiler) — set up connection details before profiling
* [Execute Profiler](/lakebridge/docs/assessment/profiler.md#execute-profiler) — run the profiler to generate the extract file consumed by this command
