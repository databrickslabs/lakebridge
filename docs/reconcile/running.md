...
## Auto-configure Table Mappings[​](#auto-configure-table-mappings "Direct link to Auto-configure Table Mappings")
...
### Recommended flow: discover, review, then auto-configure[​](#recommended-flow-discover-review-then-auto-configure "Direct link to Recommended flow: discover, review, then auto-configure")
...
### Plugging in a custom configurer[​](#plugging-in-a-custom-configurer "Direct link to Plugging in a custom configurer")
...
### Auto-configure a single table[​](#auto-configure-a-single-table "Direct link to Auto-configure a single table")
...
### Review the output[​](#review-the-output "Direct link to Review the output")
...
See [Configuration Reference](/lakebridge/docs/reconcile/configuration.md) for the full schema.
