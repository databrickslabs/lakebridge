...
Before/after examples showing how SSIS constructs are converted to Databricks. For the component support matrix, see [SSIS Supported Components](/lakebridge/docs/transpile/source_systems/ssis/supported_components.md).

***

## Data Flow Transformations[​](#data-flow-transformations "Direct link to Data Flow Transformations")

### Derived Column[​](#derived-column "Direct link to Derived Column")
...
### Conditional Split[​](#conditional-split "Direct link to Conditional Split")
...
### Lookup Transformation[​](#lookup-transformation "Direct link to Lookup Transformation")
...
## Variables and Expressions[​](#variables-and-expressions "Direct link to Variables and Expressions")

### SSIS Variables[​](#ssis-variables "Direct link to SSIS Variables")
...
### SSIS Expressions[​](#ssis-expressions "Direct link to SSIS Expressions")
...
## Control Flow Patterns[​](#control-flow-patterns "Direct link to Control Flow Patterns")

### ForEach Loop Container[​](#foreach-loop-container "Direct link to ForEach Loop Container")
...
### Execute SQL Task[​](#execute-sql-task "Direct link to Execute SQL Task")
...
## Script Component Conversion[​](#script-component-conversion "Direct link to Script Component Conversion")

### Script Task (Control Flow)[​](#script-task-control-flow "Direct link to Script Task (Control Flow)")
...
### Script Component (Data Flow)[​](#script-component-data-flow "Direct link to Script Component (Data Flow)")
...
## Complete Package Example[​](#complete-package-example "Direct link to Complete Package Example")

**SSIS Package: [LoadCustomerData.dtsx](/lakebridge/assets/files/LoadCustomerData-c19c511098b9a94677f157fc16f7c515.dtsx/)**
