...
This page lists all SSIS components and their Databricks equivalents. For usage and conversion examples, see [SSIS Conversion Examples](/lakebridge/docs/transpile/source_systems/ssis/examples.md).

***

## Control Flow (Orchestration) - Supported[​](#control-flow-orchestration---supported "Direct link to Control Flow (Orchestration) - Supported")
...
## Control Flow (Orchestration) - Unsupported[​](#control-flow-orchestration---unsupported "Direct link to Control Flow (Orchestration) - Unsupported")
...
## Data Flow (Transformation) - Supported[​](#data-flow-transformation---supported "Direct link to Data Flow (Transformation) - Supported")
...
## Data Flow (Transformation) - Unsupported[​](#data-flow-transformation---unsupported "Direct link to Data Flow (Transformation) - Unsupported")
