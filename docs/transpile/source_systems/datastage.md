...
### Supported DataStage Versions[​](#supported-datastage-versions "Direct link to Supported DataStage Versions")
...
## Stages - Supported[​](#stages---supported "Direct link to Stages - Supported")

The converter supports the following DataStage stages:

### Data Processing Stages[​](#data-processing-stages "Direct link to Data Processing Stages")
...
### Source/Target Connectors[​](#sourcetarget-connectors "Direct link to Source/Target Connectors")

| DataStage Connector     | System Type | Notes                   |
| ----------------------- | ----------- | ----------------------- |
| **Amazon S3**           | AMAZON\_S3  | AWS S3 storage          |
...
### Orchestration Stages (Sequence Jobs)[​](#orchestration-stages-sequence-jobs "Direct link to Orchestration Stages (Sequence Jobs)")
...
## DataStage Routines[​](#datastage-routines "Direct link to DataStage Routines")
...
## Sources and Targets[​](#sources-and-targets "Direct link to Sources and Targets")

The converter translates DataStage connector configurations to appropriate Spark read/write operations:

### Database Sources[​](#database-sources "Direct link to Database Sources")
...
### File Sources[​](#file-sources "Direct link to File Sources")
...
## Sequence Job Conversion[​](#sequence-job-conversion "Direct link to Sequence Job Conversion")
...
### Sequence Job Components[​](#sequence-job-components "Direct link to Sequence Job Components")
...
### Example Workflow JSON[​](#example-workflow-json "Direct link to Example Workflow JSON")
...
## Conversion Examples[​](#conversion-examples "Direct link to Conversion Examples")

### SparkSQL Output[​](#sparksql-output "Direct link to SparkSQL Output")
...
### PySpark Output[​](#pyspark-output "Direct link to PySpark Output")
...
### Pivot Stage Example[​](#pivot-stage-example "Direct link to Pivot Stage Example")
...
### Configuration Inheritance[​](#configuration-inheritance "Direct link to Configuration Inheritance")
...
### Custom Configuration Override[​](#custom-configuration-override "Direct link to Custom Configuration Override")
...
### Function Translation[​](#function-translation "Direct link to Function Translation")
...
### Source and Target Code Generation[​](#source-and-target-code-generation "Direct link to Source and Target Code Generation")
...
#### System Type Classification[​](#system-type-classification "Direct link to System Type Classification")
...
#### Reader/Writer Command Templates[​](#readerwriter-command-templates "Direct link to Reader/Writer Command Templates")
...
#### Template Tokens[​](#template-tokens "Direct link to Template Tokens")
...
#### SparkSQL Hybrid Approach[​](#sparksql-hybrid-approach "Direct link to SparkSQL Hybrid Approach")
...
### DSX File Format Error[​](#dsx-file-format-error "Direct link to DSX File Format Error")
...
### Missing Job Dependencies[​](#missing-job-dependencies "Direct link to Missing Job Dependencies")
...
### Parameter Set Resolution[​](#parameter-set-resolution "Direct link to Parameter Set Resolution")
...
* [Main ETL Conversion Guide](/lakebridge/docs/transpile.md)
