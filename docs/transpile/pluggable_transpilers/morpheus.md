...
See [Which Tool Do I Use?](/lakebridge/docs/choosing_tools.md#transpiler-bladebridge-vs-morpheus-vs-switch) for a full comparison of Morpheus, BladeBridge, and Switch.

***

## Supported Source Dialects[​](#supported-source-dialects "Direct link to Supported Source Dialects")
...
Morpheus targets **Databricks SQL** only. For ETL sources (DataStage, SSIS) or other SQL dialects (Oracle, Teradata, Redshift), use [BladeBridge](/lakebridge/docs/transpile/pluggable_transpilers/bladebridge.md) or [Switch](/lakebridge/docs/transpile/pluggable_transpilers/switch.md).

***

## How Morpheus Works[​](#how-morpheus-works "Direct link to How Morpheus Works")
...
## Correctness Guarantee Model[​](#correctness-guarantee-model "Direct link to Correctness Guarantee Model")
...
Morpheus supports `mssql`, `snowflake`, and `synapse` only. For other dialects, use [BladeBridge](/lakebridge/docs/transpile/pluggable_transpilers/bladebridge.md) (Oracle, Teradata, Netezza, Redshift, DataStage, SSIS) or [Switch](/lakebridge/docs/transpile/pluggable_transpilers/switch.md) (any dialect via LLM).
