...
## Customizable Prompts[​](#customizable-prompts "Direct link to Customizable Prompts")

You can create custom conversion prompts for Switch to handle new SQL dialects or specialized conversion requirements.

### Creating Custom Conversion Prompts[​](#creating-custom-conversion-prompts "Direct link to Creating Custom Conversion Prompts")
...
### Reference: Built-in YAML Files[​](#reference-built-in-yaml-files "Direct link to Reference: Built-in YAML Files")
...
## LLM Configuration[​](#llm-configuration "Direct link to LLM Configuration")

### Supported LLM Endpoints[​](#supported-llm-endpoints "Direct link to Supported LLM Endpoints")
...
#### Token Counting and Thresholds[​](#token-counting-and-thresholds "Direct link to Token Counting and Thresholds")

Switch sets a default threshold of **20,000 tokens per file**. Token estimation varies by model: Claude models use approximately 3.4 characters per token (meaning 20,000 tokens ≈ 68,000 characters), while other models use the tiktoken library with o200k\_base encoding. For SQL sources, Switch removes comments and compresses whitespace before counting tokens to provide more accurate estimates.

#### Adjusting the Threshold[​](#adjusting-the-threshold "Direct link to Adjusting the Threshold")
...
#### Handling Oversized Files[​](#handling-oversized-files "Direct link to Handling Oversized Files")
...
### Conversion Result Table Schema[​](#conversion-result-table-schema "Direct link to Conversion Result Table Schema")
