...
## When to Use the SQL Splitter[​](#when-to-use-the-sql-splitter "Direct link to When to Use the SQL Splitter")
...
**Note:** The output folder specified with `-o` **must already exist** before running the command. The SQL Splitter will create subfolders for each object type inside this folder.
...
[⬇ Download SQLSplitter.zip](/lakebridge/downloads/SQLSplitter.zip)
