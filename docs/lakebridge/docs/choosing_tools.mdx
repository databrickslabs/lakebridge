...
| **Configuration** | Simple: `source-dialect` flag + I/O paths | Simple: `source-dialect` flag + I/O paths + Optional JSON override files | YAML prompt files; configurable model endpoint |
...
- You need **broad SQL dialect coverage** (Oracle, Teradata, Netezza, Redshift, Synapse) with customizable configurations
