...
**Version Required:** Python between 3.10.1 and 3.14.x (inclusive).

- **Windows**: Install Python from [here](https://www.python.org/downloads/).<br/>
               Make sure you install the 64-bit version, not the 32-bit or ARM versions.
- **macOS**: Use [Homebrew](https://brew.sh) to install Python on macOS machines:
  ```shell
  brew install python
  ```
...
- ☐ Python between 3.10.1 and 3.14.x (inclusive) installed and verified (`python --version`)
