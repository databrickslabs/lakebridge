...
[GitHub release](https://github.com/databrickslabs/lakebridge/releases), from **v0.14.2** onwards.
...
|----------|-----------------------------------|---------------------------------|
| macOS    | `MacOS-Lakebridge-<version>-arm64.dmg` | `MacOS-Lakebridge-<version>-x64.dmg` |
| Windows  | `Windows-Lakebridge-<version>-arm64.exe` | `Windows-Lakebridge-<version>-x64.exe` |
