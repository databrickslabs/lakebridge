...
Each object receives one of four levels: **LOW**, **MEDIUM**, **COMPLEX**, or **VERY COMPLEX**.
...
| **COMPLEX** | High complexity — many loops, 30–50 statements, or advanced constructs (XML, PIVOT) | Plan for manual review after transpilation; test thoroughly |
| **VERY COMPLEX** | Highest complexity — heavy loop nesting, 50+ statements, or extreme PIVOT/XML usage | Allocate dedicated review time; consider using Switch for intent-aware conversion |

**Planning guidance:**

- If more than 50% of your objects score COMPLEX or VERY COMPLEX, plan for at least two manual review passes before deploying.
- Objects scored LOW and MEDIUM typically transpile cleanly with Morpheus or BladeBridge.
- COMPLEX and VERY COMPLEX objects are strong candidates for Switch, which handles business logic that deterministic transpilers struggle with.
