...
|:-----------------------------:|:-----------------------------:|:-----------------------------:|
| ABInitio |  <a href="./informatica">Informatica - PC</a> | Redshift |
| ADF | <a href="./informatica">Informatica - Big Data Edition</a> | SAS |
| Alteryx | <a href="./informatica">Informatica Cloud</a> | Snowflake |
| Athena | MS SQL Server | SPSS |
| BigQuery | Netezza | SQOOP |
| BODS | Oozie | SSIS |
| Cloudera (Impala) | Oracle | SSRS |
| Datastage | Oracle Data Integrator | Synapse |
| Greenplum | PentahoDI | Talend |
| Hive | PIG | Teradata |
| IBM DB2 | Presto | Vertica |
| Jupyter Notebook | PySpark | SAPHANA - CalcViews |
