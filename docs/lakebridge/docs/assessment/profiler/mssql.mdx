...
By default, the profiler writes the DuckDB extract to
`~/.databricks/labs/lakebridge_profilers/mssql_assessment/profiler_extract.db`.
...
databricks labs lakebridge create-profiler-dashboard \
  --extract-file ~/.databricks/labs/lakebridge_profilers/mssql_assessment/profiler_extract.db \
  --source-tech mssql \
