...
Existing credentials files without `auth_type` continue to use PAT authentication.
...
Pick **snowflake** when prompted, then choose **pat** or **key_pair** and enter the connection details.
