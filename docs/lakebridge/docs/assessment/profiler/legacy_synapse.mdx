...
- [Configure Connection to Legacy Synapse](#configure-connection-to-synapse-dedicated-sql-pool)
...
databricks labs lakebridge create-profiler-dashboard \
  --extract-file /tmp/data/legacy_synapse_assessment/profiler_extract.db \
  --source-tech legacy_synapse \
