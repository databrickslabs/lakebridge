...
Once configured, run the profiler to extract metadata and activity metrics from your Synapse workspace:
...
`~/.databricks/labs/lakebridge_profilers/synapse_assessment/profiler_extract.db`.
