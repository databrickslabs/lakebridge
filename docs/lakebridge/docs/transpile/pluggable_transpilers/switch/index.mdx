...
You'll be prompted to choose your compute type:
- **yes (default)**: Serverless job compute
- **no**: Classic job compute with LTS Spark version and USER_ISOLATION mode

The installation then:
1. Uploads Switch processing notebooks to workspace
2. Creates the Databricks Job with your selected compute type
