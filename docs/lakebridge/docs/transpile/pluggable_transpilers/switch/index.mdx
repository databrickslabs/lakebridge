...
| `informatica` | Informatica ETL → Databricks Notebook in Python or SQL for SDP |
...
| `custom_etl` | Enables you to define your own ETL conversion rules by editing the `custom_etl.yml` file located within the switch configuration. For details, see Example 6 below. |
...
### Example 6: Custom ETL to Databricks SDP in Python 

Convert ETL workload to Databricks Spark Declarative Pipeline in Python with custom instructions:
