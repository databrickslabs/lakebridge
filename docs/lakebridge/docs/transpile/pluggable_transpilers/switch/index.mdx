...
| `output_sdp` | Optional boolean parameter to enable conversion to SDP notebooks. |
| `sdp_language` | Control the language of converted SDP code, can only be "python" or "sql". |
...
flowchart TD
    ...
    validate_sdp -.-> create_pipeline[create pipeline]
