...
<Tabs>
    ...
    <TabItem value="bigquery" label="BigQuery">
        ...
        A few BigQuery types have no exact Databricks equivalent and are reconciled against their standard migration
        ...
        `remote_query` materializes its results into the `lakebridge_reconcile` BigQuery dataset.
        Create it in the same region as your source data and make it **writable** by the connection's
        service account, otherwise reads will fail.
        :::
    </TabItem>
