...
<Tabs>
    ...
    <TabItem value="bigquery" label="BigQuery">
        ...
        Results materialize into the ``lakebridge_reconcile`` dataset, which must exist in
        the same region as source data and be writable by the connection's service account.
        :::
    </TabItem>
