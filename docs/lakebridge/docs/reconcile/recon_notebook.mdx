...
class ReconcileConfig:
    ...
    creds_or_secret_scope: ReconcileCredentialsConfig | str | None = None
```
Parameters:
...
reconcile_config = ReconcileConfig(
        ...
        creds_or_secret_scope=ReconcileCredentialsConfig(
            vault_type="local",
            vault_secret_names={"sfUrl": "xxx@snowflakecomputing.com", "sfUser": "app", "sfPassword": "the P@asswort", "sfRole": "app"}
        )
    )
```
